 ...
 *    - initial release
 *
 *	// modified by Iain Urquhart to load selected items in correct order
 *
 */
...
(function($) {
  ...
  $.extend($.fn.bsmSelect, {
    ...
    conf: {
      ...
      weight: function($option) { return $option.attr('rel'); },
      // .append('<i>'+conf.listItemClass+'</i>')
